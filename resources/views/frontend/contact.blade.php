        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                ...
                <div class="location-area">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                            <ul>
                                <li><i class="fa fa-map-marker" aria-hidden="true"></i>  <span>{{$contact->adress}}</span></li>
                                <li><i class="fa fa-mobile" aria-hidden="true"></i> Phone: <a href="tel:+3301-341-0476">{{$contact->phone}}</a></li>
                                <li><i class="fa fa-envelope" aria-hidden="true"></i> <a href="mailto:info@gmail.com">{{$contact->email}}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="leave-comments-area">
                    ...
                    <form id="form_validation" action="{{url('/contactus')}}" method="post">
                        @csrf
                        <fieldset>
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="surname" id="lname" class="form-control" required placeholder="Last Name*">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="sidebar-area">
                    <div class="like-box-area">
                        <ul>
                            <li><a href="contact.html#"><i class="fa fa-facebook" aria-hidden="true"></i> <span class="like-page">like our facebook page <br/>210,956 likes</span> <span class="like"><i class="fa fa-plus" aria-hidden="true"></i></span></a></li>
                            <li><a href="contact.html#"><i class="fa fa-twitter" aria-hidden="true"></i> <span class="like-page">Follow us on twitter<br/>2109 followers</span> <span class="like">
                                <i class="fa fa-plus" aria-hidden="true"></i></span></a></li>
                            <li><a href="contact.html#"><i class="fa fa-rss" aria-hidden="true"></i> <span class="like-page">Subscribe to our rss <br/>210,956 likes</span> <span class="like"><i class="fa fa-plus" aria-hidden="true"></i></span></a></li>
                        </ul>
                    </div>
