...
class AuthorPostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.author.post.index',compact('posts','settings','images'));
    }
    ...
    public function create()
    {
        ...
        $tags = Tag::all();
        return view('backend.author.post.create',compact('settings','users','categories','tags'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Post $authorpost)
    {
        $settings = $this->getSettingsForForm();
        $categories = Category::all();
        $tags = Tag::all();
        $settings['title'] = 'Edit post';
        return view('backend.author.post.edit',compact('authorpost','settings','tags','categories'));
    }
